...
export default function ShopeeUploadClient() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        if (!kelolaFile || !incomeFile) {
            setError("Upload kedua file (Orders dan Income)");
            return;
        }
            ...
            <div className="flex items-center space-x-4 mb-8">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Upload file Orders dan Income dari Shopee Seller Center
                    </p>
                </div>
            </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                {clients.length === 0 && (
                                    <p className="text-sm text-muted-foreground">
                                        Belum ada client. Hubungi Admin.
                                    </p>
                                )}
                            </div>
                            ...
                            {/* Kelola File */}
                            <div className="space-y-2">
                                <Label>File Orders (Pesanan)</Label>
                                <div
                                ...
                                >
                                    ...
                                    {kelolaFile ? (
                                        ...
                                        <div className="text-slate-500">
                                            ...
                                            <p>Klik untuk upload file Orders</p>
                    ...
                    <Card className="border-green-500">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <Button asChild className="w-full">
                                <Link href={`/ecommerce/shopee/reports/${result.reportId}`}>
                                    Lihat Detail Report
                                </Link>
                            </Button>
                        </CardContent>
