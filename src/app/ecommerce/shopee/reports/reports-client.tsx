...
export default function ShopeeReportsClient() {
    ...
    async function fetchBrands() {
        try {
            ...
            setBrands(data.brands?.filter((b: Brand & { marketplace: string }) => b.marketplace === "SHOPEE") || []);
        } catch {
                                        ...
                                        <TableCell>
                                            <div className="flex items-center justify-end gap-2">
                                                <Button variant="ghost" size="sm" asChild>
                                                    <Link href={`/ecommerce/shopee/reports/${report.id}`}>
                                                        Detail
                                                    </Link>
                                                </Button>
                                                <Button
